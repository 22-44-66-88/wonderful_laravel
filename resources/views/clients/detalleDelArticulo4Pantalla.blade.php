                ...
                <div class="row">
                    ...
                    @foreach($images_articles as $images_article)
                            @if($images_article->estadoImagenes == 'principal')
                                <div class="col-12">
                                    <img class="product-image" src="{{asset($images_article->imagen)}}" style="width: 380px; height: 340px;">
                                </div>
                            @else
                                <div class="col-12">
                            ...
                            @if($images_article->estadoImagenes == 'secundario')
                                <div class="col-12 product-image-thumbs">
                                    <div class="product-image-thumb" ><img src="{{asset($images_article->imagen)}}" style="width: 50px ; height:40px ;"></div>
                                </div>
                            @else
                                <div class="col-12 product-image-thumbs">
                            ...
                            @foreach($articles as $article)
                                <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                    <a class="btn btn-default text-center active" href="#">
                                        ...
                                        <br>
    {{--                                    {{$article->color}}--}}
                                        <img class="img-circle fa-2x" src="{{asset('/images/colors/color1.jpg')}}" alt="">
                                    </a>
                                </div>
                            @endforeach
